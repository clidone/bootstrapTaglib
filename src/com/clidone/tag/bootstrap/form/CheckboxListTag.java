    ...
    protected String doEndTagV2() throws JspException {
        if (items != null) {
            ...
            for (int i=0,len=items.size(); i<len; i++) {
                ...
                filedLabel   = ValueUtils.isEmpty(keyValue.getValue()) ? "" : String.valueOf(keyValue.getValue());
                ...
                addBeforeContent(    "<input type=\"checkbox\" name=\""+filedName+"\" value=\""+filedValue+"\""+fieldReadonly+fieldDisabled+fieldChecked+">" + filedLabel);
